...
public:
   ...
   virtual QString GetSegmentAbbreviation() = 0;
   ...
   virtual bool GetStartList(QMap<int, QList<QString>>& segmentStartList) = 0;
   ...
   virtual bool GetWarmUpList(QMap<int, QList<QString>>& warmUpStartList) = 0;
